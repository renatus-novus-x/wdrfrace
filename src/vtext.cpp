...
#define GLYPH(ch, data) case ch: result.stroke = data; \
  ...
  switch (c) {
    GLYPH('A', kA); GLYPH('C', kC); GLYPH('D', kD);
    GLYPH('E', kE); GLYPH('F', kF); GLYPH('H', kH);
    GLYPH('I', kI); GLYPH('L', kL); GLYPH('M', kM);
    GLYPH('O', kO);
    GLYPH('P', kP); GLYPH('R', kR); GLYPH('S', kS);
    GLYPH('T', kT); GLYPH('W', kW); GLYPH('Y', kY);
    GLYPH('1', k1); GLYPH('2', k2); GLYPH('3', k3);
    GLYPH('/', kSlash);
    default: break;
  }
#undef GLYPH
